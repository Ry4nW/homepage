...
// Getting updates on the weather using Vancouver's city ID on OpenWeatherMap's API.
    (function weatherUpdate()  {
        ...
        const APIKey = '8a6ecaae68e681713d5c7ba8f9e9e732'; // API supports direct calling from client-side, aka presumably has protection.
...
infoGenerator();
setInterval(infoGenerator, 300000);